...
public class ProducerKafka {
    ...
    public static void sendMessage(String key, String value) throws InterruptedException, ExecutionException{
        ...
        Callback callback = (data, ex) -> {
            ...
            System.out.print("A mensagem é: " +data.serializedValueSize());
            System.out.println("Mensagem enviada para: " + data.topic() + " | partition " + data.partition() + "| offset " + data.offset() + "| tempo " + data.timestamp());
        };
